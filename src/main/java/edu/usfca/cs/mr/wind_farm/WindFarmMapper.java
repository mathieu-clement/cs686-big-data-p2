...
public class WindFarmMapper extends Mapper<LongWritable, Text, Text, ArrayWritable> {
    @Override
    protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
        ...
        Float temperature = observation.getFeature(TEMPERATURE_SURFACE, Float.class) - 273.15f; // K -> deg C
        ...
        context.write(new Text(geohash),
                new ArrayWritable(FloatWritable.class, new FloatWritable[]{
                        new FloatWritable(temperature), new FloatWritable(windSpeed)
                }));
    }
}
