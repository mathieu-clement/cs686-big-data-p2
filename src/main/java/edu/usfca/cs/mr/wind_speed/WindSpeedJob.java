...
public class WindSpeedJob {
    public static void main(String[] args) {
        try {
            ...
            */
            // Current class.
            job.setJarByClass(WindSpeedJob.class);
            // Mapper
            job.setMapperClass(WindSpeedMapper.class);
            // Reducer
            job.setReducerClass(WindSpeedReducer.class);
